...
const MyApp2 = props => {
  ...
  return _app_jsx(external_styled_components_["ThemeProvider"], {
    ...
    store: store
  }, _app_jsx(CommonUI_Layout, null, _app_jsx(Component, pageProps))), _app_jsx(external_react_default.a.Fragment, null, _app_jsx(GlobalStyle, null)));
};
...
MyApp2.getInitialProps = async ({
  ...
  if (ctx.isServer) {
    ...
    if (!ctx.req.headers.cookie) {
      ...
      ctx.store.dispatch(Object(loginUI["getIsLogged"])(false));
    } else {
      ctx.store.dispatch(Object(loginUI["getIsLogged"])(true));
    }
  }
