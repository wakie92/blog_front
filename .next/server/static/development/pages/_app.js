...
/* harmony import */ var _store_modules_loginUI__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../store/modules/loginUI */ "./store/modules/loginUI/index.ts");
...
const MyApp2 = props => {
  ...
  return __jsx(styled_components__WEBPACK_IMPORTED_MODULE_1__["ThemeProvider"], {
    ...
    store: store
  }, __jsx(_components_CommonUI_Layout__WEBPACK_IMPORTED_MODULE_5__["default"], null, __jsx(Component, pageProps))), __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(GlobalStyle, null)));
};
...
MyApp2.getInitialProps = async ({
  ...
  if (ctx.isServer) {
    ...
    if (!ctx.req.headers.cookie) {
      ...
      ctx.store.dispatch(Object(_store_modules_loginUI__WEBPACK_IMPORTED_MODULE_7__["getIsLogged"])(false));
    } else {
      ctx.store.dispatch(Object(_store_modules_loginUI__WEBPACK_IMPORTED_MODULE_7__["getIsLogged"])(true));
    }
  }
