...
/* harmony import */ var _lib_Routes_Routes__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../lib/Routes/Routes */ "./lib/Routes/Routes.ts");
/* harmony import */ var _components_Posts_Post_Post__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../components/Posts/Post/Post */ "./components/Posts/Post/Post.tsx");
...
const PostContainer = ({
  ...
  const reqGetPost = Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(id => {
    try {
      dispatch(_store_modules_post__WEBPACK_IMPORTED_MODULE_4__["getPostAsync"].request(id));
      router.push(`${_lib_Routes_Routes__WEBPACK_IMPORTED_MODULE_5__["ROUTES"].devBlog}/${id}`, `${_lib_Routes_Routes__WEBPACK_IMPORTED_MODULE_5__["ROUTES"].devBlog}/${id}`); // pushRoute(`post`, { id });
    } catch (e) {
      throw e;
    }
  }, [dispatch]);
  return __jsx(_components_Posts_Post_Post__WEBPACK_IMPORTED_MODULE_6__["default"], {
    title: title,
...
const loginPopup = () => {
  _config_init_firebase__WEBPACK_IMPORTED_MODULE_1__["default"].auth().signInWithPopup(_config_init_firebase__WEBPACK_IMPORTED_MODULE_1__["provider"]).then(function (result) {
