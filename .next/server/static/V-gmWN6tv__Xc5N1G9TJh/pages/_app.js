...
/* harmony import */ var _lib_Utils_asyncUtils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("y2Q3");
/* harmony import */ var typesafe_actions__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("i0Yl");
...
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("g/Tf");
...
const initialState = {
  postsList: _lib_Utils_asyncUtils__WEBPACK_IMPORTED_MODULE_7__[/* asyncState */ "a"].initial(),
  reqPost: _lib_Utils_asyncUtils__WEBPACK_IMPORTED_MODULE_7__[/* asyncState */ "a"].initial(),
  post: _lib_Utils_asyncUtils__WEBPACK_IMPORTED_MODULE_7__[/* asyncState */ "a"].initial()
};
const post = Object(typesafe_actions__WEBPACK_IMPORTED_MODULE_8__["createReducer"])(initialState, {
  [_actions__WEBPACK_IMPORTED_MODULE_9__[/* GET_POSTS_LIST */ "d"]]: state => _objectSpread({}, state, {
    postsList: _lib_Utils_asyncUtils__WEBPACK_IMPORTED_MODULE_7__[/* asyncState */ "a"].loading()
  }),
  [_actions__WEBPACK_IMPORTED_MODULE_9__[/* GET_POSTS_LIST_SUCCESS */ "f"]]: (state, action) => {
    return _objectSpread({}, state, {
      postsList: _lib_Utils_asyncUtils__WEBPACK_IMPORTED_MODULE_7__[/* asyncState */ "a"].success(action.payload)
    });
  },
  [_actions__WEBPACK_IMPORTED_MODULE_9__[/* GET_POSTS_LIST_ERROR */ "e"]]: (state, action) => _objectSpread({}, state, {
    postsList: _lib_Utils_asyncUtils__WEBPACK_IMPORTED_MODULE_7__[/* asyncState */ "a"].error(action.payload)
  }),
  [_actions__WEBPACK_IMPORTED_MODULE_9__[/* UPDATE_POST */ "i"]]: state => _objectSpread({}, state, {
    reqPost: _lib_Utils_asyncUtils__WEBPACK_IMPORTED_MODULE_7__[/* asyncState */ "a"].loading()
  }),
  [_actions__WEBPACK_IMPORTED_MODULE_9__[/* UPDATE_POST_SUCCESS */ "k"]]: (state, action) => _objectSpread({}, state, {
    reqPost: _lib_Utils_asyncUtils__WEBPACK_IMPORTED_MODULE_7__[/* asyncState */ "a"].success(action.payload)
  }),
  [_actions__WEBPACK_IMPORTED_MODULE_9__[/* UPDATE_POST_ERROR */ "j"]]: (state, action) => _objectSpread({}, state, {
    reqPost: _lib_Utils_asyncUtils__WEBPACK_IMPORTED_MODULE_7__[/* asyncState */ "a"].error(action.payload)
  }),
  [_actions__WEBPACK_IMPORTED_MODULE_9__[/* GET_POST */ "c"]]: state => _objectSpread({}, state, {
    post: _lib_Utils_asyncUtils__WEBPACK_IMPORTED_MODULE_7__[/* asyncState */ "a"].loading()
  }),
  [_actions__WEBPACK_IMPORTED_MODULE_9__[/* GET_POST_SUCCESS */ "h"]]: (state, action) => _objectSpread({}, state, {
    post: _lib_Utils_asyncUtils__WEBPACK_IMPORTED_MODULE_7__[/* asyncState */ "a"].success(action.payload)
  }),
  [_actions__WEBPACK_IMPORTED_MODULE_9__[/* GET_POST_ERROR */ "g"]]: (state, action) => _objectSpread({}, state, {
    post: _lib_Utils_asyncUtils__WEBPACK_IMPORTED_MODULE_7__[/* asyncState */ "a"].error(action.payload)
  })
}); // refactoring code

const test = Object(typesafe_actions__WEBPACK_IMPORTED_MODULE_8__["createReducer"])(initialState).handleAction(Object(_lib_Utils_asyncUtils__WEBPACK_IMPORTED_MODULE_7__[/* transformToArray */ "c"])(_actions__WEBPACK_IMPORTED_MODULE_9__[/* getPostsListAsync */ "n"]), Object(_lib_Utils_asyncUtils__WEBPACK_IMPORTED_MODULE_7__[/* handleAsyncActions */ "b"])(_actions__WEBPACK_IMPORTED_MODULE_9__[/* getPostsListAsync */ "n"], 'postsList'));
...
"use strict";
/* harmony import */ var _lib_Utils_asyncUtils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("y2Q3");
/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("Qzsm");
/* harmony import */ var typesafe_actions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("i0Yl");
...
const initialState = {
  email: '',
  password: '',
  reqLogin: _lib_Utils_asyncUtils__WEBPACK_IMPORTED_MODULE_0__[/* asyncState */ "a"].initial()
};
const login = Object(typesafe_actions__WEBPACK_IMPORTED_MODULE_2__["createReducer"])(initialState).handleAction(Object(_lib_Utils_asyncUtils__WEBPACK_IMPORTED_MODULE_0__[/* transformToArray */ "c"])(_actions__WEBPACK_IMPORTED_MODULE_1__[/* getLoginReqAsync */ "a"]), Object(_lib_Utils_asyncUtils__WEBPACK_IMPORTED_MODULE_0__[/* handleAsyncActions */ "b"])(_actions__WEBPACK_IMPORTED_MODULE_1__[/* getLoginReqAsync */ "a"], 'reqLogin'));
...
"use strict";
/* unused harmony export GET_LOGIN */
/* unused harmony export GET_LOGIN_SUCCESS */
/* unused harmony export GET_LOGIN_ERROR */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return getLoginReqAsync; });
/* harmony import */ var typesafe_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("i0Yl");
/* harmony import */ var typesafe_actions__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(typesafe_actions__WEBPACK_IMPORTED_MODULE_0__);
...
const getLoginReqAsync = Object(typesafe_actions__WEBPACK_IMPORTED_MODULE_0__["createAsyncAction"])(GET_LOGIN, GET_LOGIN_SUCCESS, GET_LOGIN_ERROR)();
...
// EXTERNAL MODULE: ./store/modules/post/reducers.ts
var reducers = __webpack_require__("IAdA");

// EXTERNAL MODULE: ./store/modules/loginAsync/index.ts
var loginAsync = __webpack_require__("z5Zo");
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return asyncState; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return transformToArray; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return handleAsyncActions; });
/* harmony import */ var _babel_runtime_corejs2_core_js_object_define_property__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("hfKm");
/* harmony import */ var _babel_runtime_corejs2_core_js_object_define_property__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs2_core_js_object_define_property__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _babel_runtime_corejs2_core_js_object_define_properties__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("2Eek");
/* harmony import */ var _babel_runtime_corejs2_core_js_object_define_properties__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs2_core_js_object_define_properties__WEBPACK_IMPORTED_MODULE_1__);
...
"use strict";
/* harmony import */ var _reducers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("JhYM");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "default", function() { return _reducers__WEBPACK_IMPORTED_MODULE_0__["a"]; });

/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("Qzsm");
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("fNoD");
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_types__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _saga__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("aP5D");
