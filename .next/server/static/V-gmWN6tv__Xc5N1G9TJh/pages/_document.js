...
/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("mw/K");
...
/* harmony import */ var path__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("oyvS");
...
class NextHeadWithInlineCss extends next_document__WEBPACK_IMPORTED_MODULE_8__["Head"] {
  getInlineCss() {
    const {
      files
    } = this.context._documentProps;
    ...
    const filtered = files.filter(file => /\.css$/.test(file)).map(file => __jsx("style", {
      key: file,
      dangerouslySetInnerHTML: {
        __html: Object(fs__WEBPACK_IMPORTED_MODULE_10__["readFileSync"])(Object(path__WEBPACK_IMPORTED_MODULE_11__["join"])(process.cwd(), '.next', file), 'utf-8')
      }
    }));
    return filtered;
  }
  ...
  render() {
    ...
    return __jsx("head", this.props, __jsx("meta", {
      name: "description",
      content: "\uB9AC\uC561\uD2B8\uB97C \uC8FC\uB85C \uAC1C\uBC1C\uD558\uB294 \uC8FC\uB2C8\uC5B4 \uD504\uB860\uD2B8\uC5D4\uB4DC \uAC1C\uBC1C\uC790\uC785\uB2C8\uB2E4. \uD56D\uD574\uC0AC\uAC00 \uD56D\uD574\uC77C\uC9C0\uB97C \uAE30\uB85D\uD558\uB4EF \uAC1C\uBC1C\uACFC \uC9C0\uC2DD\uC758 \uB85C\uADF8\uB97C \uAE30\uB85D\uD558\uAE30 \uC704\uD55C \uBE14\uB85C\uADF8\uC785\uB2C8\uB2E4."
    }), __jsx("meta", {
      name: "keyword",
      content: "frot-end"
    }), __jsx("meta", {
      ...
      name: "keyword",
      content: "javascript"
    }), head, this.getInlineCss(), this.props.children);
  }
...
class MyDocument extends next_document__WEBPACK_IMPORTED_MODULE_8___default.a {
  ...
  render() {
    return __jsx(next_document__WEBPACK_IMPORTED_MODULE_8__["Html"], null, __jsx(next_document__WEBPACK_IMPORTED_MODULE_8__["Head"], null, __jsx("title", null, "Oscar's devlog")), __jsx(NextHeadWithInlineCss, null), __jsx("body", null, __jsx(next_document__WEBPACK_IMPORTED_MODULE_8__["Main"], null), __jsx("div", {
      id: "modal"
