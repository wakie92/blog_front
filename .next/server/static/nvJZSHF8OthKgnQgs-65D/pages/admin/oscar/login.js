...
/* harmony import */ var _lib_Utils_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("no1e");
/* harmony import */ var _store_modules_loginUI__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("oTr5");
...
const login = ({
  ...
  const onSumit = async e => {
    e.preventDefault();
    const res = await Object(_lib_Utils_utils__WEBPACK_IMPORTED_MODULE_1__[/* loginEmail */ "c"])(email, password);

    if (res) {
      dispatch(Object(_store_modules_loginUI__WEBPACK_IMPORTED_MODULE_2__["getIsLogged"])(true));
      router.push('/', '/');
    }
  };
