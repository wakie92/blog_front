...
Home.getInitialProps = async ({
  ...
  if (isServer) {
    await Object(utils["a" /* checkUser */])();
    console.log('home');
...
/* unused harmony export loginPopup */
...
const loginPopup = () => {
  _config_init_firebase__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].auth().signInWithPopup(_config_init_firebase__WEBPACK_IMPORTED_MODULE_1__[/* provider */ "c"]).then(function (result) {
    const token = _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(result.credential.toJSON());
...
const Header = ({
  ...
  }, Header_jsx("span", null, "About"))), Header_jsx(Hamburger, {
    toggle: toggle,
...
const HeaderContainer = () => {
  ...
  const moveRouter = () => {
    router.push(`${Routes["a" /* ROUTES */].about}`, `${Routes["a" /* ROUTES */].about}`);
  };
