...
})(["width:100%;main{width:76.8rem;margin:auto;display:flex;flex-direction:column;.main-img{margin:auto;padding-bottom:4rem;max-height:50rem;max-width:100%;}@media screen and (max-width:", "){width:90%;}}hr{width:100%;border:1px solid ", ";margin:2rem 0;}"], responsive["a" /* breakpoints */].medium, global["a" /* colors */].gray5);
...
// CONCATENATED MODULE: ./components/Utterances/Utterances.tsx

var Utterances_jsx = external_react_default.a.createElement;
...
const Utterances = () => {
  const rootElm = external_react_default.a.createRef();
  Object(external_react_["useEffect"])(() => {
    ...
    keys_default()(config).forEach(configKey => {
  ...
  return Utterances_jsx("div", {
    className: "utternces",
    ref: rootElm
  });
};

/* harmony default export */ var Utterances_Utterances = (Utterances);
...
function PostView({
  ...
  }), PostView_jsx(Utterances_Utterances, null)));
}
const Layout = external_styled_components_default.a.div.withConfig({
  displayName: "PostView__Layout",
  componentId: "sc-1sxi1s2-0"
})(["width:calc(100% - 10rem);margin:auto;min-height:70rem;padding:2rem;margin-top:20rem;@media screen and (max-width:", "){width:calc(100% - 4rem);}"], responsive["a" /* breakpoints */].medium);
...
const BlogPostContainer = ({
  ...
  const reqDeletePost = Object(external_react_["useCallback"])(async () => {
    try {
      dispatch(modules_post["deletePostAsync"].request(postData.data.resId));
    } catch (e) {
      throw e;
    }
  }, [dispatch]);
  console.log(postData.data);
  return BlogPostContainer_jsx(external_react_default.a.Fragment, null, BlogPostContainer_jsx(PostView, {
    isLogged: isLogged,
    reqDeletePost: reqDeletePost,
    postData: postData,
    editMode: editMode,
...
/* harmony default export */ var Edit_EditContainer = (external_react_default.a.memo(EditContainer));
...
// CONCATENATED MODULE: ./lib/Constant.ts
const HOME_URL = 'http://huuun-log.me/';
// CONCATENATED MODULE: ./components/Posts/PostView/PostSeo.tsx

var PostSeo_jsx = external_react_default.a.createElement;
...
const PostSeo = ({
  ...
  return PostSeo_jsx(head_default.a, null, PostSeo_jsx("title", null, title), PostSeo_jsx("meta", {
    name: "og:title",
    content: title
  }), subTitle && PostSeo_jsx("meta", {
    name: "description",
    content: subTitle
  }), subTitle && PostSeo_jsx("meta", {
    name: "og:description",
    ...
    name: "og:url",
    content: `${HOME_URL}/dev/blog/${resId}`
  }), imgUrl && PostSeo_jsx("meta", {
    name: "og:image",
    content: imgUrl
  }));
};

/* harmony default export */ var PostView_PostSeo = (PostSeo);
...
const _id_post = ({}) => {
  ...
  return _id_jsx(external_react_default.a.Fragment, null, _id_jsx(PostView_PostSeo, {
    data: postData.data
...
/* harmony default export */ var SubTItleInput = (external_react_default.a.memo(SubTitleInput));
...
/* harmony default export */ var Write_TagAndImg = (external_react_default.a.memo(TagAndImg));
...
/* harmony default export */ var Write_Head = (external_react_default.a.memo(Head));
...
/* harmony default export */ var Write_Preview = (external_react_default.a.memo(Preview));
const Wrapper = external_styled_components_default.a.div.withConfig({
...
/* concated harmony reexport Preview */__webpack_require__.d(__webpack_exports__, "c", function() { return Write_Preview; });
